               ...
               <div class="row" style="padding: 20px;">
                 <div class="col-md-12">
                    ...
                    <div class="form-group row">
                      ...
                      <input type="text" class="form-control col-md-8 abc " readOnly   value="<?php echo date("d-m-Y",$lis->startdate); ?>" id="startdate1" required/>
                    </div>
                   <div class="form-group row">
                      <label for="email" class="col-md-4 p-0">License End Date:</label>
                      <input type="text" class="form-control col-md-8 end" readOnly value="<?php $date12 = $lis->enddate; echo date("d-m-Y",$date12); ?>" id="enddate1" required/>
                    </div>
                    <div class="form-group row">
                      <label for="email" class="col-md-4 p-0">Course Cut of Date:</label>
                      <input type="text" class="form-control col-md-8 abc" readOnly value="<?php echo date("d-m-Y",$lis->cutoffdate); ?>" id="coutoffdate1" required/>
                    </div>
                    <div class="form-group row">
...
<span class="span ml-0"><?php echo $coursename->fullname; ?>
      <input type="hidden" value="<?php echo $coursename->id; ?>"></input>
</span>
<?php
     }
  }
