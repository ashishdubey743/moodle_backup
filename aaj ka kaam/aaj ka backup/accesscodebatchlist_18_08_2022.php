               ...
               <table class="table table-striped table-bordered">
                  ...
                  <tbody id="tbody">
                     ...
                     <tr>
                        ...
                        <td style="width: 175px;"><a href="editaccesscode.php?bid=<?php echo $value->id ?>" class="" style="padding:6px 10px;"><i class="fa fa-pencil" title="Edit" aria-hidden="true" style="color:#000;" id="yui_3_17_2_1_1657800997774_21"></i></a><a href="exportdata.php?id=<?php echo $value->id?>" class="" style="padding:6px 10px;"><i class="fa fa-download" title="Export" aria-hidden="true" style="color:#000;" id="yui_3_17_2_1_1657800997774_21"></i></a>   <a href="#" class="" style="padding:6px 10px;"><i class="fa fa-eye" title="Enable" aria-hidden="true" style="color:#000;" id="yui_3_17_2_1_1657800997774_21"></i></a>
                      
                         <a href="#" class="" style="padding:6px 10px;"><i class="fa fa-list-alt" title="List" aria-hidden="true" style="color:#000;" id="yui_3_17_2_1_1657800997774_21"></i></a></td>
                     </tr>
                    <?php }?> 
                     
                  </tbody>
               </table>
               <div style="text-align: end;"><a href="#" class="button" style="padding: 8px 54px; margin-right: 12px;" onclick="Disablebulk();">Bulk Disable</a><a href="#" class="button" style="padding: 8px 54px; margin-right: 12px;" onclick="Disablebulk();">Bulk Enable</a></div>
            </div>
         </div>
      </div>
    </div>
