               ...
               <div class="row" style="padding: 20px;">
                 <div class="col-md-12">
                   ...
                   <div class="col-md-4 pl-0 d-flex">
                    ...
                    <div class="form-group row">
                      <label for="batch" class="col-md-4 p-0">Exclude Characters <span class="err2">  *</span></label>
...
<script>
  function addaccess(){
    ...
    if(no_ofcodes==''||batch_name==''||access_type==''||course_id==''||code_pref==''||
      code_suff==''||code_length=='' || role_id==''){
