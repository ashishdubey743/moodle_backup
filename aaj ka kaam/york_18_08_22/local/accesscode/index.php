               ...
               <div class="row" style="padding: 20px;">
                 <div class="col-md-12">
                    ...
                    <div class="form-group row">
                      <label for="email" class="col-md-4 p-0">No. of Access Codes <span class="err2">  *</span></label>
                      <!-- <select class="form-control col-md-8" id="noofcode">
                       ...
                       <input type="text" class="form-control col-md-8" placeholder="Enter Number of Codes" id="noofcode">
                    </div>
                    <div class="form-group row">
                   ...
                   <div class="col-md-4 pr-0">
                      <label for="email" class="">Code Length <span class="err2">*</span></label>
...
<script>
  function addaccess(){
    ...
    if(no_ofcodes==''||batch_name==''||access_type==''||course_id=='' || code_length=='' || role_id==''){
     ...
     else if(isNaN(nocode) == true){
      
        alert("Please Enter Correct Values for Number of Codes!");
        }
      // CHANGES FROM HERE
      else{
        $.ajax({
